...
export default function NewItem({ onAddItem }) {
    ...
    const handleSubmit = (e) => {
        ...
        // Create item object
        const item = {
            id: generateRandomString(16), // Generate a random 16-character ID
            name,
            quantity,
            category,
        };

        onAddItem(item); // Call onAddItem prop with the item object
    ...
    return (
        <div className="ml-4 mb-6 p-6 bg-gray-900 rounded-lg shadow-md max-w-md text-white">
